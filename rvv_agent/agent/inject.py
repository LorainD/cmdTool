...
NOTE: 本文件中的大部分功能已被 patch.py 中的对应实现替代。
      保留此文件用于向后兼容和作为共享工具函数的来源。
"""
...
# NOTE: 以下函数已被 patch.py 中的对应实现替代，保留用于向后兼容
...
#
#     DEPRECATED: 使用 patch.py::_locate_insertion_line_llm 替代。
#     """
...
#     """DEPRECATED: 使用 patch.py 中的内联实现替代。"""
...
#     """DEPRECATED: 使用 patch.py::_snippet_already_present 替代。"""
...
#     """DEPRECATED: 使用 patch.py::_snapshot 替代。"""
#     try:
...
#     """DEPRECATED: 使用 patch.py::_inject_asm_file 替代。"""
...
#     """DEPRECATED: 使用 patch.py::_inject_text_file 替代。"""
#     rel = str(dst)
#     if not dst.exists():
#         ensure_dir(dst.parent)
#         write_text(dst, content)
...
#
#     DEPRECATED: 使用 patch.py::apply_patch 替代。
#
#     Parameters
#     ----------
...
# ---------------------------------------------------------------------------
# Context-aware stage wrapper (DEPRECATED)
# ---------------------------------------------------------------------------
